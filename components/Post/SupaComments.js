...
const SupaComments = () => {
  ...
  return (
    <>
      ...
      <div className='hidden mt-10 space-y-4 rounded-full w-10 h-10' />
      <div className='hidden animate-pulse space-x-4 flex-1 h-2 w-20 rounded grid-cols-3 gap-4 col-span-2' />
      <div
        id='comments'
