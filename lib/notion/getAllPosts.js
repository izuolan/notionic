...
export async function getAllPosts({
  ...
  if (
    ...
    const notionPosts = filterPublishedPosts({
    ...
    // Merge markdown posts (skip for hidden/newsletter queries)
    const markdownRaw = getAllMarkdownPosts()
    const markdownPosts = onlyHidden || onlyNewsletter
      ? []
      : filterPublishedPosts({ posts: markdownRaw, onlyNewsletter, onlyPost, onlyHidden })
